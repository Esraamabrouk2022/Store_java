...
import com.company.dp.entity.Branch;
...
public class BranchRebo {
    ...
    public int intsert(Branch branch) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            preparedStatement.setTime(6, branch.getWorking_start());
            preparedStatement.setTime(7, branch.getWorking_end());
    ...
    public List<Branch> Selectall() throws SQLException, ClassNotFoundException {
        ...
        while (resultSet.next()) {
            ...
            branch.setWorking_start(resultSet.getTime("working_start"));
            branch.setWorking_end(resultSet.getTime("working_end"));
